...
#ifndef ZEPHYR_INCLUDE_ZEPHYR_DT_BINDINGS_CLOCK_ALIF_ENSEMBLE_E1C_CLOCKS_H_
#define ZEPHYR_INCLUDE_ZEPHYR_DT_BINDINGS_CLOCK_ALIF_ENSEMBLE_E1C_CLOCKS_H_

#include "alif_clocks_common.h"

/* soc specific registers */
#define ALIF_OSPI_CTRL_REG             0x3CU /* CLKCTL_PER_SLV_CLKCTL module */
...
#define ALIF_LPPDM_76M8_CLK         \
	ALIF_CLK_CFG(M55HE_CFG, HE_CLK_ENA, 8U, 1U, 0U, 0U, 0U)
...
#define ALIF_CANFD0_HFOSC_CLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CANFD_CTRL, 8U, 1U, 0U, 1U, 9U)
#define ALIF_CANFD0_160M_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CANFD_CTRL, 8U, 1U, 1U, 1U, 9U)
#define ALIF_CANFD1_HFOSC_CLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CANFD_CTRL, 24U, 1U, 0U, 1U, 25U)
#define ALIF_CANFD1_160M_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CANFD_CTRL, 24U, 1U, 1U, 1U, 25U)

/* I2S clocks */
#define ALIF_I2S0_76M8_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S0_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_I2S1_76M8_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S1_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_LPI2S_76M8_CLK         \
	ALIF_CLK_CFG(M55HE_CFG, HE_I2S_CTRL, 12U, 1U, 0U, 0U, 0U)
