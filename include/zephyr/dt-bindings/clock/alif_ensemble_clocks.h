...
#define ALIF_CAMERA_PIX_PLL_CLK3   \
	ALIF_CLK_CFG(CLKCTL_PER_MST, CAMERA_PIXCLK_CTRL, 0U, 1U, 1U, 1U, 4U)

/* CDC200 pixel clocks */
#define ALIF_CDC200_PIX_SYST_ACLK  \
	ALIF_CLK_CFG(CLKCTL_PER_MST, CDC200_PIXCLK_CTRL, 0U, 1U, 0U, 1U, 4U)
#define ALIF_CDC200_PIX_PLL_CLK3   \
	ALIF_CLK_CFG(CLKCTL_PER_MST, CDC200_PIXCLK_CTRL, 0U, 1U, 1U, 1U, 4U)
...
#define ALIF_CSI_PIX_PLL_CLK3       \
	ALIF_CLK_CFG(CLKCTL_PER_MST, CSI_PIXCLK_CTRL, 0U, 1U, 1U, 1U, 4U)
...
#define ALIF_LPCPI_PXL_CLK          \
	ALIF_CLK_CFG(M55HE_CFG, HE_CAMERA_PIXCLK, 0U, 1U, 0U, 0U, 0U)
...
/* GPU clock */
#define ALIF_GPU_CLK                \
	ALIF_CLK_CFG(CLKCTL_PER_MST, PERIPH_CLK_ENA, 8U, 1U, 0U, 0U, 0U)

/* Ethernet clocks */
#define ALIF_ETHERNET_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_MST, PERIPH_CLK_ENA, 12U, 1U, 0U, 0U, 0U)
#define ALIF_ETH_RMII_REFCLK_PIN    \
	ALIF_CLK_CFG(CLKCTL_PER_MST, ETH_CTRL, 0U, 0U, 0U, 1U, 4U)
#define ALIF_ETH_RMII_PLL_CLK_50M    \
	ALIF_CLK_CFG(CLKCTL_PER_MST, ETH_CTRL, 0U, 0U, 1U, 1U, 4U)
...
/* USB clock */
#define ALIF_USB_CLK                \
	ALIF_CLK_CFG(CLKCTL_PER_MST, PERIPH_CLK_ENA, 20U, 1U, 0U, 0U, 0U)
...
#define ALIF_BACKUP_RAM_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, EXPMST0_CTRL, 4U, 1U, 0U, 0U, 0U)

/* PDM clocks */
#define ALIF_PDM_76M8_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, EXPMST0_CTRL, 8U, 1U, 0U, 1U, 9U)
#define ALIF_PDM_AUDIO_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, EXPMST0_CTRL, 8U, 1U, 1U, 1U, 9U)
#define ALIF_LPPDM_76M8_CLK         \
	ALIF_CLK_CFG(M55HE_CFG, HE_CLK_ENA, 8U, 1U, 0U, 1U, 9U)
#define ALIF_LPPDM_AUDIO_CLK        \
	ALIF_CLK_CFG(M55HE_CFG, HE_CLK_ENA, 8U, 1U, 1U, 1U, 9U)

/* UART clocks */
#define ALIF_UART0_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 0U, 1U, 0U, 1U, 8U)
#define ALIF_UART0_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 0U, 1U, 1U, 1U, 8U)
#define ALIF_UART1_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 1U, 1U, 0U, 1U, 9U)
#define ALIF_UART1_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 1U, 1U, 1U, 1U, 9U)
#define ALIF_UART2_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 2U, 1U, 0U, 1U, 10U)
#define ALIF_UART2_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 2U, 1U, 1U, 1U, 10U)
#define ALIF_UART3_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 3U, 1U, 0U, 1U, 11U)
#define ALIF_UART3_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 3U, 1U, 1U, 1U, 11U)
#define ALIF_UART4_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 4U, 1U, 0U, 1U, 12U)
#define ALIF_UART4_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 4U, 1U, 1U, 1U, 12U)
#define ALIF_UART5_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 5U, 1U, 0U, 1U, 13U)
#define ALIF_UART5_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 5U, 1U, 1U, 1U, 13U)
#define ALIF_UART6_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 6U, 1U, 0U, 1U, 14U)
#define ALIF_UART6_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 6U, 1U, 1U, 1U, 14U)
#define ALIF_UART7_38M4_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 7U, 1U, 0U, 1U, 15U)
#define ALIF_UART7_SYST_PCLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, UART_CTRL, 7U, 1U, 1U, 1U, 15U)
#define ALIF_LPUART_CLK             \
	ALIF_CLK_CFG(AON, RTSS_HE_LPUART_CKEN, 0U, 1U, 0U, 0U, 0U)

/* CAN-FD clocks */
#define ALIF_CANFD0_HFOSC_CLK       \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CANFD_CTRL, 12U, 1U, 0U, 1U, 16U)
#define ALIF_CANFD0_160M_CLK        \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CANFD_CTRL, 12U, 1U, 1U, 1U, 16U)

/* I2S clocks */
#define ALIF_I2S0_76M8_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S0_CTRL, 12U, 1U, 0U, 1U, 20U)
#define ALIF_I2S0_AUDIO_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S0_CTRL, 12U, 1U, 1U, 1U, 20U)
#define ALIF_I2S1_76M8_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S1_CTRL, 12U, 1U, 0U, 1U, 20U)
#define ALIF_I2S1_AUDIO_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S1_CTRL, 12U, 1U, 1U, 1U, 20U)
#define ALIF_I2S2_76M8_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S2_CTRL, 12U, 1U, 0U, 1U, 20U)
#define ALIF_I2S2_AUDIO_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S2_CTRL, 12U, 1U, 1U, 1U, 20U)
#define ALIF_I2S3_76M8_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S3_CTRL, 12U, 1U, 0U, 1U, 20U)
#define ALIF_I2S3_AUDIO_CLK         \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, I2S3_CTRL, 12U, 1U, 1U, 1U, 20U)
#define ALIF_LPI2S_76M8_CLK         \
	ALIF_CLK_CFG(M55HE_CFG, HE_I2S_CTRL, 12U, 1U, 0U, 1U, 16U)
#define ALIF_LPI2S_AUDIO_CLK        \
	ALIF_CLK_CFG(M55HE_CFG, HE_I2S_CTRL, 12U, 1U, 1U, 1U, 16U)
...
#define ALIF_ADC0_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, ADC_CTRL, 0U, 1U, 0U, 0U, 0U)
#define ALIF_ADC1_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, ADC_CTRL, 4U, 1U, 0U, 0U, 0U)
#define ALIF_ADC2_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, ADC_CTRL, 8U, 1U, 0U, 0U, 0U)
#define ALIF_ADC24_CLK              \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, ADC_CTRL, 12U, 1U, 0, 0U, 0U)

/* DAC clocks */
#define ALIF_DAC0_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, DAC_CTRL, 0U, 1U, 0U, 0U, 0U)
#define ALIF_DAC1_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, DAC_CTRL, 4U, 1U, 0U, 0U, 0U)

/* Comparator clocks */
#define ALIF_CMP0_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CMP_CTRL, 0U, 1U, 0U, 0U, 0U)
#define ALIF_CMP1_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CMP_CTRL, 4U, 1U, 0U, 0U, 0U)
#define ALIF_CMP2_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, CMP_CTRL, 8U, 1U, 0U, 0U, 0U)
...
#define ALIF_GPIO1_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO1_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO2_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO2_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO3_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO3_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO4_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO4_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO5_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO5_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO6_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO6_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO7_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO7_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO8_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO8_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO9_DB_CLK           \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO9_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO10_DB_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO10_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO11_DB_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO11_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO12_DB_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO12_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO13_DB_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO13_CTRL, 12U, 1U, 0U, 0U, 0U)
#define ALIF_GPIO14_DB_CLK          \
	ALIF_CLK_CFG(CLKCTL_PER_SLV, GPIO14_CTRL, 12U, 1U, 0U, 0U, 0U)
...
#define ALIF_DMA0_CLK               \
	ALIF_CLK_CFG(CLKCTL_PER_MST, PERIPH_CLK_ENA, 4U, 1U, 0U, 0U, 0U)
#define ALIF_DMA1_CLK               \
	ALIF_CLK_CFG(M55HP_CFG, HP_CLK_ENA, 4U, 1U, 0U, 0U, 0U)
#define ALIF_DMA2_CLK               \
	ALIF_CLK_CFG(M55HE_CFG, HE_CLK_ENA, 4U, 1U, 0U, 0U, 0U)

/* UTIMER clocks */
#define ALIF_UTIMER_CLK     ALIF_CLK(1U)
#define ALIF_LPUTIMER_CLK           \
	ALIF_CLK_CFG(M55HE_CFG, HE_CLK_ENA, 17U, 1U, 0U, 0U, 0U)
