...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_MISC_ALIF_AIPM_ENSEMBLE_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_MISC_ALIF_AIPM_ENSEMBLE_H_

/*
 * AIPM DT binding constants for base Ensemble SoCs (E1/E3/E5/E7).
 * Includes memory block bitmasks and EWIC event masks.
 * Values must stay in sync with the branch of aipm.h.
 */
...
#define ALIF_SRAM6A_MASK     (1 << 8)   /* Modem ITCM */
#define ALIF_SRAM6B_MASK     (1 << 9)   /* Modem DTCM */
#define ALIF_SRAM7_1_MASK    (1 << 10)  /* XTENSA ITCM1 */
#define ALIF_SRAM7_2_MASK    (1 << 11)  /* XTENSA ITCM2 */
#define ALIF_SRAM7_3_MASK    (1 << 12)  /* XTENSA ITCM3 */
...
#define ALIF_SERAM_MASK      (1 << 18)
#define ALIF_FWRAM_MASK      (1 << 19)
#define ALIF_BACKUP4K_MASK   (1 << 20)
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_MISC_ALIF_AIPM_ENSEMBLE_H_ */
