...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_MISC_ALIF_AIPM_ENSEMBLE_E1C_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_MISC_ALIF_AIPM_ENSEMBLE_E1C_H_

/*
 * AIPM DT binding constants for Ensemble E1C SoC.
 * Includes memory block bitmasks and EWIC event masks.
 * Values must stay in sync with the CONFIG_SOC_SERIES_E1C branch of aipm.h.
 */
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_MISC_ALIF_AIPM_ENSEMBLE_E1C_H_ */
